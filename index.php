...
?>
    ...
    <header>
        <div class="header-left">
            <img src="https://mospolytech.ru/local/templates/main/dist/img/logos/mospolytech-logo-black.svg" alt="МосПолитех">
        </div>
        <div class="header-center">Записная книжка - Управление контактами</div>
        
        <!-- MENU -->
        <?= renderMenu($page, $sortBy) ?>
    </header>
    ...
    <!-- FOOTER -->
    <footer>
        Лабораторная работа №2 - Записная книжка
    </footer>
